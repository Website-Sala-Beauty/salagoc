...
public partial class web_module_module_app_web_CapNhatXuHuong : System.Web.UI.Page
{
    ...
    protected void loadData()
    {
        ...
        var getData = from xh in db.tb_SanPhams
                      where xh.loaisanpham_id==48
                      orderby xh.sanpham_id descending
                      select new
                      {
                          xh.sanpham_id,
                          xh.sanpham_name,
                          ...
                          tinhtrang = (from gh in db.tb_HoaDonChiTiets
                                       ...
                                       where hd.khachhang_id == getkh.khachhang_id && gh.sanpham_id == xh.sanpham_id
                          ...
                          heart = (from h in db.tb_Hearts 
                                  ...
                                  where h.khachhang_id == getkh.khachhang_id && h.sanpham_id == xh.sanpham_id
                                  select h).Count()>0? "fa-heart" : "fa-heart-o"

                      };
        rpXuhuong.DataSource = getData;
        rpXuhuong.DataBind();
    }
