<%@ Page Title="" Language="C#" MasterPageFile="~/AppMasterPage.master" AutoEventWireup="true" CodeFile="web_CapNhatXuHuong.aspx.cs" Inherits="web_module_module_app_web_CapNhatXuHuong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="navabar">
        ...
        <div class="tieude"><span style="margin-left: 9%;">ALBUM NAILS XU HƯỚNG</span></div>
        <div class="icon-infor">
            <uc1:linqheader runat="server" ID="linqheader" />
        </div>
    </div>
    <div class="base">
        <asp:ScriptManager ID="scrXuhuong" runat="server">
        </asp:ScriptManager>
        <asp:UpdatePanel ID="upXuHuong" runat="server">
            <ContentTemplate>
                <div class="block-nailbox row">
                    <asp:Repeater ID="rpXuhuong" runat="server">
                        <ItemTemplate>
                            <div class="box col-5">
                ...
                <div style="display: none">
                    ...
                    <a href="javascipt:void(0)" id="btnChonSanPham" runat="server" onserverclick="btnChonSanPham_ServerClick"></a>
