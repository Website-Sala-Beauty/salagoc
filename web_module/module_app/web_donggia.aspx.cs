...
public partial class web_module_module_app_web_DongGia : System.Web.UI.Page
{
    ...
    protected void loadData()
    {
        ...
        var getData = from dg in db.tb_SanPhams
                      where dg.loaisanpham_id == 42
                      select new
                      {
                          dg.sanpham_id,
                          dg.sanpham_name,
                          ...
                          tinhtrang = (from gh in db.tb_HoaDonChiTiets
                                       ...
                                       where hd.khachhang_id == getkh.khachhang_id && gh.sanpham_id == dg.sanpham_id
                          ...
                          heart = (from h in db.tb_Hearts
                                   ...
                                   where h.khachhang_id == getkh.khachhang_id && h.sanpham_id == dg.sanpham_id
                                   select h).Count() > 0 ? "fa-heart" : "fa-heart-o"
                      };
        rpDonggia.DataSource = getData;
        rpDonggia.DataBind();
    }
