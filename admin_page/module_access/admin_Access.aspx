...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="card card-block">
        <div class="col-lg-6">
            ...
            <dx:ASPxGridView ID="grvUser" runat="server" ClientInstanceName="grvUser" KeyFieldName="username_id" Width="80%">
                <Columns>
        ...
        <div class="col-lg-5">
            <h4 class="title">List Form</h4>
            <dx:ASPxGridView ID="grvUserForm" runat="server" ClientInstanceName="grvUserForm" KeyFieldName="form_id" Width="60%">
                <Columns>
