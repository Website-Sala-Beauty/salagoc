...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <script type="text/javascript">
       ...
       <%-- function checkNULL() {
            var CityName = document.getElementById('<%= txtTenxuhuong.ClientID%>');
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="slide_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Ảnh slide" FieldName="slide_image" Width="20%" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
