...
public partial class admin_page_module_function_module_DichVu : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        ...
        grvList.DataBind();
        ddlNhom.DataSource = from lsp in db.tb_LoaiSanPhams where lsp.sanpham_parent == "dichvu" select lsp;
        ddlNhom.DataBind();              
    ...
    {
        if (txtTensanpham.Text != "" && txtGiatien.Value != "")
            return true;
        else return false;
    }
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                if (cls.Them_SanPham(txtTensanpham.Text, txtThongtin.InnerText, Convert.ToInt32(txtGiatien.Value.ToString()), "", Convert.ToInt32(ddlNhom.Value)))
                {
