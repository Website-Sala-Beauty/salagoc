...
public partial class admin_page_module_function_module_XuHuong : System.Web.UI.Page
{
    ...
    private void loadData()
    {
        ...
        grvList.DataBind();
        ddlLoai.DataSource = from l in db.tb_LoaiSanPhams where l.loaisanpham_id==48 select l;
        ddlLoai.DataBind();
    }
