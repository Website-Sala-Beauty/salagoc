...
public partial class admin_page_module_function_module_DongGia : System.Web.UI.Page
{
    dbcsdlDataContext db = new dbcsdlDataContext();
    cls_Alert alert = new cls_Alert();
    public string image;
    public int giatien = 69000;
    private int _id;
    ...
    private void loadData()
    {
        ...
        grvList.DataBind();
        ddlLoai.DataSource = from l in db.tb_LoaiSanPhams where l.loaisanpham_id==42 select l;
        ddlLoai.DataBind();
    }
    ...
    protected void btnLuu_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                if (cls.Them_SanPham_NailsBox(txtTennailbox.Text, giatien, image, Convert.ToInt32(ddlLoai.SelectedItem.Value)))
                {
            ...
            else
            {
                ...
                if (cls.Sua_SanPham_NailsBox(Convert.ToInt32(Session["_id"].ToString()), txtTennailbox.Text, giatien, image, Convert.ToInt32(ddlLoai.SelectedItem.Value)))
                {
