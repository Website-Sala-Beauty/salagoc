<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_MauNails.aspx.cs" Inherits="admin_page_module_function_module_MauNails" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="sanpham_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Hình ảnh" FieldName="sanpham_image" Width="15%" HeaderStyle-HorizontalAlign="Center" CellStyle-VerticalAlign="Middle">
                        <DataItemTemplate>
