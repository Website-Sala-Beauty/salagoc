<%@ Page Title="Quản lý mã giảm giá khách hàng" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_MaGiamGiaKhachHang.aspx.cs" Inherits="admin_page_module_function_module_KhachHang" %>
        ...
        <div class="form-group table-responsive">
            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="magiamgia_id" Width="100%">
                <Columns>
                    ...
                    <dx:GridViewDataColumn Caption="Tên mã giảm giá" FieldName="magiamgia_name" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Số lượng mã giảm giá" FieldName="magiamgia_soluong" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    ...
                    <dx:GridViewDataColumn Caption="Ngày hết hạn" FieldName="magiamgia_ngayketthuc" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn Caption="Nội dung mã giảm giá" FieldName="magiamgia_noidung" HeaderStyle-HorizontalAlign="Center" Width="20%"></dx:GridViewDataColumn>
                </Columns>
