<%@ Page Title="Quản lý Nailbox" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_NailsBox.aspx.cs" Inherits="admin_page_module_function_module_NailsBox" %>
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 form-group">
                                            ...
                                            <div class="col-10">
                                                <asp:TextBox ID="txtGiatien" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="92%" min="0"> </asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-12">
