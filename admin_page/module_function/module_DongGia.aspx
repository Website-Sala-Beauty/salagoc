<%@ Page Title="Quản lý Nailbox" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_DongGia.aspx.cs" Inherits="admin_page_module_function_module_DongGia" %>
                                ...
                                <div class="col-12">
                                    <div class="col-12">
                                        ...
                                        <%--<div class="col-12 form-group">
                                            ...
                                            <div class="col-10">
                                                <asp:TextBox ID="txtGiatien" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="92%"  > </asp:TextBox>
                                            </div>
                                        </div>--%>
                                        <div class="col-12">
