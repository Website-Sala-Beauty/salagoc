<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_LoaiSanPham.aspx.cs" Inherits="admin_page_module_function_module_LoaiSanPham" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <script type="text/javascript">
        ...
        function checkNULL() {
            var CityName = document.getElementById('<%= txttenloai.ClientID%>');
                            ...
                            <div class="div_content col-12">
                                <div class="col-12">
                                    ...
                                    <div class="col-12 form-group">
                                        ...
                                        <div class="col-10">
                                            <asp:TextBox ID="txttenloai" runat="server" ClientIDMode="Static" CssClass="form-control boxed" Width="90%"> </asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 form-group">
                                        ...
                                        <table hidden="hidden">
                                            <tr>
                                                ...
                                                <th>
                                                    <dx:ASPxTextBox ID="txtSEO_KEYWORD" runat="server" ClientInstanceName="SEO_KEYWORD" CssClass="InputText"
                                                        Width="100%">
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th>
                                                    <dx:ASPxTextBox ID="txt_SEOTITLE" runat="server" ClientInstanceName="SEO_TITLE" CssClass="InputText"
                                                        Width="100%">
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th>
                                                    <dx:ASPxTextBox ID="txtSEO_LINK" runat="server" ClientInstanceName="SEO_LINK" CssClass="InputText" Width="100%">
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th>
                                                    <input name="txtSEO_DES" type="text" id="SEO_DES" runat="server" class="InputText" style="width: 99.5%; height: 30px" onkeydown="CountLeft(hibodywrapper_popupControl_SEO_DEP, this.form.left,160);" onkeyup="CountLeft(hibodywrapper_popupControl_SEO_DEP,this.form.left,160);" />
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <dx:ASPxTextBox ID="txtSEO_IMAGE" runat="server" ClientInstanceName="SEO_IMAGE" CssClass="InputText" Width="100%">
                                                    </dx:ASPxTextBox>
                                                </th>
                                            </tr>
                                        </table>
